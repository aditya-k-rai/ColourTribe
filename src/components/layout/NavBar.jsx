        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            >
              ...
              {getItemCount() > 0 && (
                <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-[10px] font-bold leading-none text-navy bg-gold rounded-full transform translate-x-1/4 -translate-y-1/4 select-none">
                  {getItemCount()}
                </span>
              )}
            </button>
              ...
              <div className="container mx-auto px-6 py-6 flex flex-col gap-1">
                {navLinks.map((link) => (
                  <Link
                    key={link.to}
                    to={link.to}
                    className={`py-3 px-4 rounded-lg text-sm uppercase tracking-wider font-semibold transition-colors ${
                      location.pathname === link.to
