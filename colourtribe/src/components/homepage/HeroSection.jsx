...
// Dynamically import the heavy Three.js scene to optimize initial load
  ...
  return (
    <section className="relative w-full h-[100svh] overflow-hidden flex flex-col items-center justify-center bg-[#070d17]">
      ...
      <div className="absolute inset-0 z-0">
        <Suspense fallback={
          <div className="w-full h-full bg-gradient-to-br from-navy to-[#050a12] animate-pulse" />
        }>
          <HeroScene />
        </Suspense>
      </div>
          ...
          >
            ...
            <Link to="/contact" className="group flex items-center gap-4 text-white hover:text-gold transition-colors duration-300">
              <motion.div 
                ...
                whileTap={{ scale: 0.9 }}
                className="relative w-14 h-14 rounded-full border border-white/30 flex items-center justify-center bg-white/5 backdrop-blur-md group-hover:border-gold group-hover:bg-gold/10 transition-all"
              >
